...
Solidity & Vyper developer. I build on-chain infrastructure — governance systems, DeFi protocols, upgradeable contract architectures.

I choose tools deliberately. Vyper when auditability is a priority. Solidity when the ecosystem demands it. Both when the project warrants it.

Currently focused on DAO governance design and AMM protocol research.
...
- DAO governance & proposal systems
- DeFi protocols — AMMs, vaults, tokenomics
